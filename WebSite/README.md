...
However, despite adapting the settings related to Security Groups, namely Inbound and Outbound Rules, as indicated in *Figure 5* and *Figure 6*, when using the University of Aveiro (UA) network, we encountered a limitation that prevented access to the deployed backend's IP address for security reasons.

![1704537497868](image/README/1704537497868.png)
*Figure 5: EC2 Instance Inbound Rules*

![1704537514162](image/README/1704537514162.png)
*Figure 6: EC2 Instance Outbound Rules*
